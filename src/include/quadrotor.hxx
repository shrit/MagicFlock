...
template<class simulator_t, class NoiseType>
unsigned int
Quadrotor<simulator_t, NoiseType>::id() const
{
  return id_;
}
...
template<class simulator_t, class NoiseType>
std::string
Quadrotor<simulator_t, NoiseType>::name() const
{
  return name_;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::add_nearest_neighbor_id(unsigned int id)
{
...
Quadrotor<simulator_t, NoiseType>::nearest_neighbors() const
{
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::stop_sampling_rt_state()
{
  rt_samples_->stop();
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::sample_state()
{
  State<simulator_t, NoiseType> state(sim_interface_, id_, nearest_neighbors_);
  current_state_ = state;
  all_states_.push_back(state);
...
Quadrotor<simulator_t, NoiseType>::current_state() const
{
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>&
Quadrotor<simulator_t, NoiseType>::current_predicted_state()
{
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>
Quadrotor<simulator_t, NoiseType>::current_predicted_state() const
{
  return current_predicted_state_;
}
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>&
Quadrotor<simulator_t, NoiseType>::current_predicted_enhanced_state()
{
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>
Quadrotor<simulator_t, NoiseType>::current_predicted_enhanced_state() const
{
  return current_predicted_enhanced_state_;
}
...
Quadrotor<simulator_t, NoiseType>::all_states() const
{
  return all_states_;
}
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>
Quadrotor<simulator_t, NoiseType>::last_state()
{
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>
Quadrotor<simulator_t, NoiseType>::before_last_state()
{
...
template<class simulator_t, class NoiseType>
State<simulator_t, NoiseType>
Quadrotor<simulator_t, NoiseType>::before_2_last_state()
{
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::reset_all_states()
{
  all_states_.clear();
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::current_loss(arma::vec loss_vector)
{
...
template<class simulator_t, class NoiseType>
arma::vec
Quadrotor<simulator_t, NoiseType>::current_loss() const
{
  return loss_vector_;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::current_action(Actions::Action action)
{
...
template<class simulator_t, class NoiseType>
Actions::Action
Quadrotor<simulator_t, NoiseType>::current_action() const
{
...
template<class simulator_t, class NoiseType>
Actions::Action
Quadrotor<simulator_t, NoiseType>::last_action()
{
...
template<class simulator_t, class NoiseType>
Actions::Action
Quadrotor<simulator_t, NoiseType>::before_last_action()
{
...
template<class simulator_t, class NoiseType>
Actions::Action
Quadrotor<simulator_t, NoiseType>::before_2_last_action()
{
...
Quadrotor<simulator_t, NoiseType>::all_actions() const
{
  return all_actions_;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::reset_all_actions()
{
  all_actions_.clear();
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_state()
{
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_data_set()
{
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_data_set_with_current_predictions()
{
  data_set_.save_csv_data_set_2_file(
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_data_set_with_loss()
{
  data_set_.save_csv_data_set_2_file(
    name_ + "_loss",
    vec_.to_std_vector(before_last_state().Data()),
...
void
Quadrotor<simulator_t, NoiseType>::register_loss(Arg arg, Args... args)
{
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_histogram(int count)
{
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_actions_evaluation(
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::register_episodes(int n_episodes)
{
...
template<class simulator_t, class NoiseType>
bool
Quadrotor<simulator_t, NoiseType>::examin_geometric_shape()
{
  bool shape =
...
template<class simulator_t, class NoiseType>
double
Quadrotor<simulator_t, NoiseType>::speed() const
{
  return speed_;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::increase_speed()
{
  speed_++;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::decrease_speed()
{
  speed_--;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::increase_speed_by_value(double speed)
{
  speed_ = speed_ + speed;
}
...
template<class simulator_t, class NoiseType>
void
Quadrotor<simulator_t, NoiseType>::decrease_speed_by_value(double speed)
{
  speed_ = speed_ - speed;
}
...
template<class simulator_t, class NoiseType>
double
Quadrotor<simulator_t, NoiseType>::distance_to(int id)
{
