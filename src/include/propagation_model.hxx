...
Propagation_model<rssi_t>::
Propagation_model(std::shared_ptr<rssi_t> rssi_interface):
...
template <class rssi_t>
double Propagation_model<rssi_t, double>::
friis_convert_watt_to_distance(double receiver_power)
{
...
template <class rssi_t>
double Propagation_model<rssi_t, double>::
friis_convert_dbm_to_distance(double receiver_power)
{
...
template <class rssi_t>
double Propagation_model<rssi_t>::
ITU_convert_dbm_to_distance(double receiver_power)
{
...
template <class rssi_t>
std::vector<double> Propagation_model<rssi_t>::
estimated_distances_3D()
{
...
template <class rssi_t>
double Propagation_model<rssi_t>::dbm_to_watt(double value)
{
  double rssi_watt;
...
double Propagation_model<rssi_t>::Hz_to_Ghz(double value)
{
  double f_ghz ;
...
template <class rssi_t>
void Propagation_model<rssi_t>::wave_length()
{
